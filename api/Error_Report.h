...
typedef enum { NO_ERROR, ERR_IMU, ERR_EEPROM, ERR_USB_HID, ERR_SD_CARD, ERR_LCD, ERR_IR, ERR_MOTOR_0, ERR_MOTOR_1, ERR_OTHER, ERR_RADIO, ERR_PORT_EXP, ERR_I2C } error_e;

typedef enum { ERR_LVL_LOG, ERR_LVL_WARNING, ERR_LVL_ERROR, ERR_LVL_CRITICAL, ERR_LVL_MISSING } error_level_e;
