...
led_status_e led_ctorGPIO(led_t* const led, led_mode_e mode, led_polarity_e polarity, const uint16_t gpio_pin, GPIO_TypeDef* const gpio_port);

led_status_e led_ctorPWM(led_t* const led, led_mode_e mode, TIM_HandleTypeDef* htim, uint32_t channel);
