...
typedef enum { DISPLAY_TFT_NOT_INIT = 0, DISPLAY_TFT_NO_ERROR, DISPLAY_TFT_ERROR } tft_display_status_e;

typedef enum { PORT_EXPANSOR_NOT_INIT = 0, PORT_EXPANSOR_NO_ERROR, PORT_EXPANSOR_ERROR } portExpansor_status_e;
