...
void print_textBar(graphicalObject_t* arg1) {
    ...
    for (int i = 0; i < (my_container->NumLines); i++) {
        ...
        u8g2_DrawBox(&u8g2, my_container->gObj.topLeft.x, my_container->gObj.topLeft.x, my_container->gObj.botRight.x - my_container->gObj.topLeft.x,
                     my_container->gObj.botRight.y - my_container->gObj.topLeft.y);
