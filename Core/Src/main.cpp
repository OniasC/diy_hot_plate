...
itemName_t* itemNameList[6] = {(itemName_t*)"op1", (itemName_t*)"op2", (itemName_t*)"op3", (itemName_t*)"op4", (itemName_t*)"op5", (itemName_t*)"op6"};

itemName_t* itemNameList1[6] = {(itemName_t*)"1-op1", (itemName_t*)"1-op2", (itemName_t*)"1-op3", (itemName_t*)"1-op4", (itemName_t*)"1-op5", (itemName_t*)"1-back"};
...
// Variables
Thermistor* therm1 = new NTC_Thermistor(Thermistor_PIN, REFERENCE_RESISTANCE, NOMINAL_RESISTANCE, NOMINAL_TEMPERATURE, B_VALUE,
...
void refreshDisplay() {
    ...
    */
    ...
    else if (running_mode == hotPlateState_COOLDOWN) { // Mode 11 is cooldown. SSR is OFF
    ...
    else if (running_mode == hotPlateState_REFLOW) { // Mode 1 is the PID runnind with selected mode 1
                                                     /*
                                                         lcd.clear();
                                                         lcd.setCursor(0,0);
                                                         lcd.print("T: ");
...
int main(void) {
    ...
    graphicalObject_t* subMenusFromMenu0[6] = {&menuList1.gObj, &menuList1.gObj, &menuList1.gObj, &menuList1.gObj, &menuList1.gObj, &menuList1.gObj};

    graphicalObject_t* subMenusFromMenu1[6] = {&menuList.gObj, &menuList.gObj, &menuList.gObj, &menuList.gObj, &menuList.gObj, &menuList.gObj};
